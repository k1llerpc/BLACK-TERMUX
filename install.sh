...
echo -e "${BLUE}╔══════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}║            ${GREEN}BLACK-TERMUX Setup${BLUE}                     ║${NC}"
echo -e "${BLUE}╚══════════════════════════════════════════════════════╝${NC}"
echo ""
...
read -p "Möchtest du die BLACK-TERMUX Shell beim Start von Termux automatisch laden? (j/n): " AUTO_START
...
if [[ "$AUTO_START" == "j" || "$AUTO_START" == "J" ]]; then
    ...
    if ! grep -q "termux_custom_shell.sh" $HOME/.bashrc; then
        echo -e "\n# Starte BLACK-TERMUX Shell" >> $HOME/.bashrc
...
print("="*50)
print("Willkommen zur BLACK-TERMUX Shell!")
...
echo -e "${YELLOW}Du kannst die BLACK-TERMUX Shell starten mit:${NC}"
...
echo -e "\n${GREEN}Viel Spaß mit deiner neuen BLACK-TERMUX Shell!${NC}" 